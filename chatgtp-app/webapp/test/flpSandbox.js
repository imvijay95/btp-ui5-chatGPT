			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"chatgtpapp-display": {
								"semanticObject": "chatgtpapp",
								"action": "display",
								"description": "A Fiori application to test ChatGPT functions",
								"title": "ChatGPT App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=chatgtpapp",
									"url": sap.ui.require.toUrl("chatgtpapp")
								}
							}
						}
					}
